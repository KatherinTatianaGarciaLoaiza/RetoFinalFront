        ...
        <List>
          <Accordion >
            ...
            <Accordion.Collapse eventKey="0">
              <Card.Body><Link to={`/AllOKRS`} className="button" className="body" style={{ color: "#000" }}>Todos los OKR</Link></Card.Body>
            </Accordion.Collapse>
            <Divider />
            <Accordion.Collapse eventKey="0">
              <Card.Body><Link to={`/ShowMaxProgressOkr`} className="button" className="body" style={{ color: "#000" }} >
            ...
            <Accordion.Collapse eventKey="1">
              <Card.Body><Link to={`/ConfigurationNotifications`} className="button" className="body" style={{ color: "#000" }}>Configuracion de notificaciones</Link></Card.Body>
            </Accordion.Collapse>
          </Accordion>
        </List>
      </div>
